...
# from dependency_parser.biaffine.my_library.models.WordLanguageModel.glyph_embedding.models.glyph_embedding import WordGlyphEmbedding

logger = logging.getLogger(__name__)  # pylint: disable=invalid-name

POS_TO_IGNORE = {'``', "''", ':', ',', '.', 'PU', 'PUNCT', 'SYM'}

@Model.register("biaffine_parser_glyph")
class BiaffineDependencyParser(Model):
    ...
    def __init__(self,
        ...
        b = vocab.get_index_to_token_vocabulary(namespace='char')
        glyph_config['idx2word'] = {k: v for k, v in a.items()}
        glyph_config['idx2char'] = {k: v for k, v in b.items}

        self.glyph = WordGlyphEmbedding(glyph_config)
