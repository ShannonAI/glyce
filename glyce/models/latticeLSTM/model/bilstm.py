...
from glyce.models.latticeLSTM.model.charbilstm import CharBiLSTM
from glyce.models.latticeLSTM.model.charcnn import CharCNN
from glyce.models.latticeLSTM.model.latticelstm import LatticeLSTM
...
class BiLSTM(nn.Module):
    def __init__(self, data):
        ...
        if self.use_glyph:
            ...
            self.glyph_embedding = CharGlyceEmbedding(self.glyph_config)
    ...
    def get_output_score(self, gaz_list, word_inputs, biword_inputs, word_seq_lengths, char_inputs, char_seq_lengths,
                         char_seq_recover):
        lstm_out, glyph_loss = self.get_lstm_features(gaz_list, word_inputs, biword_inputs, word_seq_lengths,
    ...
    def neg_log_likelihood_loss(self, gaz_list, word_inputs, biword_inputs, word_seq_lengths, char_inputs,
        ...
        outs, glyph_loss = self.get_output_score(gaz_list, word_inputs, biword_inputs, word_seq_lengths, char_inputs,
